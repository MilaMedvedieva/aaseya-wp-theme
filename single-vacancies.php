...
if (has_post_thumbnail()) {
    ...
    $arhive_img = get_field('vacancies_bg','options')['url'];
    $paralax_img = '<div class="parallax-window" data-parallax="scroll" data-image-src="' . $arhive_img . '"></div>';
}
if ( function_exists('get_field') )
{
    ...
    $show_social_top = get_field('show_social_top');
    $show_social_bottom = get_field('show_social_bottom');
}
?>
                    ...
                    <div class="row">
                            ...
                            <div class="mt-5">
                                <p class="post-data-info">
                                    ...
                                    if ( !empty( $terms ) ):
                                        ...
                                        $term_link = get_term_link($term->slug, $post_taxonomy);
                                        ?>
                        ...
                        <?php if(isset($block_downloads) and !empty($block_downloads)):?>
                            <div class="content-downloads <?php  echo $class_row_d;?>">
                               <?php foreach ($block_downloads as $value):?>
                                 <?php endforeach; ?>
            ...
            <div class="content-bottom">
                <div class="container">
                    <div class="row">
                        ...
                        <?php endif; ?>
                        <?php if($show_social_bottom): ?>
                            <div class="col-12 social_bottom ">
                                <?php echo do_shortcode('[Sassy_Social_Share title="Share"]'); ?>
                            </div>
                        <?php endif; ?>
                    </div>
