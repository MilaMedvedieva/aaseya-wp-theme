...
$bg_image = get_field('bright_and_shiny_bg','options');
$archive_title = get_field('bright_and_shiny_title','options');
?>
  <section class="paget">
                        ...
                        <form action="#" method="post" accept-charset="utf-8" class="filter_post_form" id="filter_post_form">
                            <div class="wrapper">
                                ...
                                <div class="f_category" >
                                    <select class="filter_select filter_by_category" style="opacity: 0;" id="filter_by_category" name="category []" multiple="multiple">
                                        <?php
                                ...
                                <div class="f_date">
                                    <select class="filter_select" name="archive-dropdown" id="filter_by_date">
                                        <option></option>
                                        <option>All</option>
                                        <?php  echo wp_get_cpt_archives('newsroom',$args_date); ?>
                                    </select>
                                </div>
                            </div>
                        </form>
