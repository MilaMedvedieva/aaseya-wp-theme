...
$bg_image = get_field('events_bg','options');
$event_title = get_field('events_title','options');
...
<section class="paget">
    ...
    <div class="paget-inner">
        ...
        <div class="paget-bottom">
            <div class="container">
                <?php if(isset($event_title) && !empty($event_title)): ?>
                    <h1 class="paget-title"> <?php echo $event_title;?></h1>
                <?php else: ?>
                        ...
                        <div class="wrapper">
                            ...
                            <div class="f_date">
                                <select class="filter_select" name="archive-dropdown" id="filter_by_date">
                                    <option></option>
                                    <option>All</option>
                                    <?php  echo wp_get_cpt_archives('events',$args_date); ?>
                                </select>
                            </div>
                        </div>
                    </form>
